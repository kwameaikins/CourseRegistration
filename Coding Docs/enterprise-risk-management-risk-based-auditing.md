---
title: "Enterprise Risk Management and Risk-Based Auditing"
slug: "enterprise-risk-management-risk-based-auditing"
# PLACEHOLDER — this brief arrived without a course_code and the founder has
# not confirmed one. It must match courses.course_code in the database, and the
# matching key in modules/courses/public-content.ts, or the programme page
# renders without its copy.
course_code: "ERM1"
page_type: "course"
delivery: "Live online via Zoom"
primary_cta: "Register Now"
registration_url: "https://reg.knowsia.com/programmes/ERM1"
---

# Enterprise Risk Management and Risk-Based Auditing

## Turn organisational risks into focused, practical audit priorities

Develop practical skills in enterprise risk management and risk-based auditing. Learn how to identify and assess key risks, build an effective risk register, and translate risk information into a focused internal audit plan.
...
[**Register Now**](https://reg.knowsia.com/programmes/ERM1)

**Course fee:** GH₵469  
**Early-bird offer:** 15% off  
**Corporate discount:** 15% off for companies registering four or more participants  
**Seats:** Limited  
...
[**Secure Your Seat**](https://reg.knowsia.com/programmes/ERM1)
...
### Session 1: Risk Concepts and Types of Risk
...
### Session 3: Developing a Risk Register
...
### Session 4: Risk-Based Internal Audit Planning
...
### Session 5: Practical Group Exercise

Participants will work through a practical case study to:
...
| Delivery | Live, instructor-led session via Zoom |
| Duration | One-day intensive training |
| Facilitator | Mr. Isaac Adjin Bonney, CA, CPFA, CFIP |
| Certification | Verifiable Certificate of Completion |
| Learner portal | Personal portal for the meeting link, resources, and course materials |
...
- Register and manage multiple staff from one account

**Companies registering four or more participants receive a 15% discount.**
...
**Group discount:** 15% off for companies registering four or more participants
...
Yes. Companies registering four or more participants receive a 15% discount.

---

## Ready to Build a More Risk-Focused Audit Approach?

Learn how to connect enterprise risks, risk registers, controls, and internal audit planning in one practical intensive programme.
