---
title: "AI-Powered Financial Reporting, Analysis, Financial Modelling & Automation"
slug: "ai-powered-financial-reporting-analysis-modelling-automation"
course_code: "AI02"
page_type: "course"
delivery: "Live online via Zoom"
primary_cta: "Register Now"
registration_url: "https://reg.knowsia.com/programmes/AI02"
---

# AI-Powered Financial Reporting, Analysis, Financial Modelling & Automation
...
**5:30 PM – 8:30 PM GMT daily**  
**Live and interactive via Zoom**  
**15 training hours · CPD 15**

[**Register Now**](https://reg.knowsia.com/programmes/AI02)

**Course fee:** GH₵860  
**Early-bird fee:** GH₵731 by 3 August 2026  
**Corporate discount:** 15% off for companies registering five or more participants  
**Seats:** Limited  
**Facilitator:** Mr. Stephen Kwame Aikins, CA
...
This programme prepares participants to apply AI within their existing finance workflows to improve speed and accuracy without surrendering professional judgement.
...
[**Reserve Your Place**](https://reg.knowsia.com/programmes/AI02)
...
### AI-in-Excel Assistants

Use AI for formula building, review, analysis, and reporting directly within Excel.

### AI Code and Automation Assistants

Generate and review macros, scripts, and automations for repetitive Excel tasks.

### Conversational AI

Use chat-based AI for analysis, drafting, management commentary, and multi-step reporting workflows.

Participants should have access to Microsoft Excel—Microsoft 365 is recommended—and an active AI tool account before the programme. Setup guidance will be provided during the first session.
...
## Foundations: AI as a Finance Tool
...
## Automation, Workflow Design and Capstone
...
| Time | 5:30 PM–8:30 PM GMT daily |
| Delivery | Live, instructor-led via Zoom |
| Duration | Five sessions, three hours each |
| Total training | 15 hours |
| CPD | 15 |
| Support | Cohort WhatsApp group with facilitator |
| Learner portal | Personal portal for meeting links and materials |
| Facilitator | Mr. Stephen Kwame Aikins, CA |
...
Organisations enrolling staff receive access to a Corporate Portal that enables HR or management to:
...
### What level of Excel knowledge is required?

Participants should be comfortable with common Excel formulas and pivot tables.

### What software or accounts do I need?

You should have Microsoft Excel—Microsoft 365 is recommended—and an active AI tool account.

### How will the training be delivered?

The programme consists of five live and interactive Zoom sessions.
...
Yes. The course includes a certificate reflecting 15 training hours and CPD 15.
...
## Transform the Way You Work in Finance

Move beyond occasional AI experiments. Build practical, repeatable workflows for financial reporting, analysis, modelling, and automation.

[**Register Now**](https://reg.knowsia.com/programmes/AI02)

**Contact:** 020 370 1923  
