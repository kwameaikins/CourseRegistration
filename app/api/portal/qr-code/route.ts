...
// GET /api/portal/qr-code?code=XYZ&batchId=... — a student-ambassador's own
// QR for one of their own codes (2026-08-02 follow-up, mirrors
// /api/partner-portal/qr-code exactly). Ownership is checked against
// getReferralSummaryForSession's own code list.
