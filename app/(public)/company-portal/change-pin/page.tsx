...
// Forced-on-first-login PIN change for the corporate portal — mirrors
// app/(public)/portal/change-pin/page.tsx exactly.
...
export default function CompanyPortalChangePinPage() {
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    setSubmitting(true);
    try {
      await apiFetch('/api/company-portal/change-pin', {
        method: 'POST',
