...
// Forced-on-first-login PIN change for the partner portal — mirrors
// app/(public)/company-portal/change-pin/page.tsx exactly.
...
export default function PartnerPortalChangePinPage() {
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    setSubmitting(true);
    try {
      await apiFetch('/api/partner-portal/change-pin', {
        method: 'POST',
